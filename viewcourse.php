...
<div>
            ...
            <h4>We aim to make studying SIMPLE, EASY and ACCESSIBLE to EVERYONE thus we collected the BEST COURSES in the world in one place.</h4>
</div>
<div class="container-fluid servicebody" id="myservice_section">
			 ...
			 <div class="row">
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="userlogin.php">PROGRAMMING</a></h3>
         				<p>
				 ...
				 <div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="userlogin.php">VIDEO TUTORIALS</a></h3>
         				<p>
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="homepage.php">BACK TO HOME</a></h3>   <!--  exercise/exercise.php -->
         				<p>
         					Here you will find all website related information click here to redirect    
							Home
         				</p>
         			</div>
					<br>
		...
		<br>	<section class="work" id="work"><br><br>
