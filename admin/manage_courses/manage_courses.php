...
.tab-card-header > .tab-content {
 ...
 <!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="../admin_main.php">Elearn</a>
...
<!-- sidebar starts -->
        ...
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            ...
            <li class="list-group-item bg-dark"><a href="http://localhost/e-learnp/admin/manage_videos/manage_videos.php">Manage Videos</a></li>
            <li class="list-group-item bg-dark"><a href="../viewfeedback.php">Manage feedbacks</a></li>
            <li class="list-group-item bg-dark"><a href="../index.php">Logout</a></li>
